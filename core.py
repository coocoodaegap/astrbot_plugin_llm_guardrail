...
class RailContext:
    ...
    # Output mutations are committed once after the terminal Step 5 pass.
    # This keeps retry candidates out of the user-visible response.
    output_needs_commit: bool = False
    ...
    # P3 stores only a compact, non-sensitive retry summary.  The output text
    # and any review payload remain outside this trace.
