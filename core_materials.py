...
CORE_MATERIALS = build_core_material_set(
    ...
    (
        ...
        CoreMaterialEntry(
            "language_response_directive",
            "language_intent",
            "core-materials-v6",
            "first_party_design",
            "Recognize a bounded response-language command around a named language.",
            "test_language_drift_materials_preserve_current_boundaries",
            (
                (
                    "directive_prefixes",
                    (
                ...
                ("code_markers", ("language", "lang", "语言", "語言")),
                ("coordination_markers", ("and", "or", "/", "、", "和", "或")),
            ),
        ),
        CoreMaterialEntry(
            "language_target_scripts",
            "language_intent",
            "core-materials-v6",
            "first_party_design",
            "Map a small set of explicit language names, aliases, and codes to abstract scripts.",
            "test_language_drift_materials_preserve_current_boundaries",
            (
                ("script_classes", ("latin", "han", "japanese", "hangul", "cyrillic", "arabic")),
                (
                    "latin_aliases",
                    (
                        "english",
                ...
                ("han_aliases", ("chinese", "zh", "中文", "汉语", "漢語", "普通话", "普通話")),
                ("japanese_aliases", ("japanese", "ja", "日本語", "日语", "日文")),
                ("hangul_aliases", ("korean", "ko", "한국어", "韩语", "韓語")),
                ("cyrillic_aliases", ("russian", "ru", "русский", "俄语", "俄語")),
                ("arabic_aliases", ("arabic", "ar", "العربية", "阿拉伯语", "阿拉伯語")),
            ),
        ),
        CoreMaterialEntry(
            "language_ignored_technical_tokens",
            "language_intent",
            "core-materials-v6",
            "first_party_design",
            "Exclude common Latin technical tokens from local script-drift evidence.",
            "test_language_drift_materials_preserve_current_boundaries",
            (
                (
                    "terms",
        ...
        CoreMaterialEntry(
            "format_response_directive",
            "format_contract",
            "core-materials-v7",
            "first_party_design",
            "Recognize a bounded output-format command around a verifiable format anchor.",
            "test_format_violation_materials_preserve_current_boundaries",
            (
                (
                    "directive_prefixes",
                    (
        ...
        CoreMaterialEntry(
            ...
            "core-materials-v7",
            "first_party_design",
            "Describe the closed output structures that the local validator can verify safely.",
            "test_format_violation_materials_preserve_current_boundaries",
            (
                ("json_object_terms", ("json object", "json对象", "json dictionary", "json dict")),
                ("json_array_terms", ("json array", "json数组", "array of json")),
                ("single_line_terms", ("single line", "one line", "单行", "一行")),
                ("plain_text_terms", ("plain text", "plaintext", "text only", "纯文本")),
                ("plain_text_negative_terms", ("no markdown", "without markdown", "do not use markdown", "不要 markdown", "不要使用 markdown", "不要markdown")),
                ("code_fence_required_terms", ("code fence", "fenced code", "代码围栏", "代码块")),
                ("code_fence_forbidden_terms", ("no code fence", "without code fence", "do not use a code fence", "do not use code fences", "不要代码围栏", "不要代码块", "不使用代码围栏", "不使用代码块")),
            ),
        ),
        CoreMaterialEntry(
            "refusal_response_stance",
            "refusal_structure",
            "core-materials-v8",
            "first_party_design",
            "Recognize a small set of direct refusal stances without judging the refused topic.",
            "test_refusal_leakage_materials_preserve_current_boundaries",
            (
                (
                    "terms",
                    (
        ...
        CoreMaterialEntry(
            "refusal_protected_boundary",
            "refusal_structure",
            "core-materials-v8",
            "first_party_design",
            "Name protected instruction and context boundaries that make a refusal explanation reviewable.",
            "test_refusal_leakage_materials_preserve_current_boundaries",
            (
                (
                    "terms",
        ...
        CoreMaterialEntry(
            "refusal_causal_connector",
            "refusal_structure",
            "core-materials-v8",
            "first_party_design",
            "Strengthen an otherwise local refusal-boundary relation with an explicit reason connector.",
            "test_refusal_leakage_materials_preserve_current_boundaries",
            (
                (
                    "terms",
